...
import BookGPT from "../assets/BookGPT.png";
      ...
      <div className="animate__animated animate__flipInX card">
        ...
        <div className="description">
          ...
          <div className="project_description">
            <BsBalloonFill style={{ width: "20px", height: "20px" }} />
            <div>
              달력에서 이번 달의 일기를 모두 불러올 수 있으며, 일기를 작성,
              조회, 삭제할 수 있습니다
            </div>
          </div>
          <div className="site">
      ...
      <div className="animate__animated animate__flipInX card">
        ...
        <div className="description">
          ...
          <div className="project_description">
            <BsBalloonFill style={{ width: "20px", height: "20px" }} />
            <div>
              React Context를 활용하여 전역적으로 상태를 관리하고, 클라이언트의
              한 번의 요청으로 서버로부터 데이터를 지속적으로 받아오기 위해
