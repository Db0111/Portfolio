    ...
    <>
      ...
      <div className="main_container2" ref={ref2}>
        ...
        >
          ...
          개발팀 옆에서 처음으로 코드를 읽어보려고 노력했던 순간 이후로, 개발에
          흥미를 붙이게 되었습니다. 공부하는 과정에서 만나는 문제들은 저에게
          장애물이 아니라 새로운 도전으로 다가왔습니다.
        </h2>
        <h2
          className={`animate__animated ${
            inView2 ? "animate__fadeInLeft" : ""
        ...
        >
          프론트엔드 개발에 발을 들이면서, 매 순간 더 나아가고자 하는 열정으로
          코드를 작성하고, 완벽한 사용자 경험을 만들어내고 싶습니다. 한 번
          시작하면 쉽게 포기하지 않으며, 언제나 배움을 통해 성장하고자 하는 제
          자신이 가장 큰 원동력입니다.
        </h2>
      </div>
    </>
